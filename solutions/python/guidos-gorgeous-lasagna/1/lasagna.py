...
def preparation_time_in_minutes(number_of_layers: int) -> int:
    ...
    Returns:
        int: The time (in minutes) it will take to prepare the lasagna derived from 'PREPARATION_TIME'.
...
def elapsed_time_in_minutes(number_of_layers: int, elapsed_bake_time: int) -> int:
    ...
    Returns:
        int: The amount of time that has elapsed (in minutes) derived from 'preparation_time_in_minutes()'
